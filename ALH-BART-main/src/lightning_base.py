...
class BaseTransformer(pl.LightningModule):
    def __init__(
        ...
        **config_kwargs
        ...
        # assert hparams.attention_group < config.encoder_layers
        self.config.attention_group = hparams.attention_group
        ...
        self.config.sent_encoder = hparams.sent_encoder
        self.config.use_graph = hparams.use_graph
